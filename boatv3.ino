...
const int MOTOR_IN1 = 4; // L298N Input 1
const int MOTOR_IN2 = 5; // L298N Input 2
...
void setup()
{
    ...
    Serial.println("System initialized with DC motor control");
}
...
void processCommand(String command)
{
    ...
    else if (command.startsWith("MOTOR_"))
    {
